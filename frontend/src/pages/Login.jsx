                        ...
                        <div className="text-center">
                            ...
                            <div className="flex flex-col md:flex-row gap-4 justify-center mb-6">
                                <div className="bg-white p-3 rounded-xl shadow-inner border border-slate-100">
                                    <QRCode
                                        value="https://github.com/Rudrappa838/school-software/raw/main/release/schoolapp.apk"
                                        size={130}
                                        level="H"
                                    />
                            ...
                            <div className="space-y-3">
                                <a
                                    href="https://github.com/Rudrappa838/school-software/raw/main/release/schoolapp.apk"
